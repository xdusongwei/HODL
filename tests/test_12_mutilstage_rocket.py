...
class MultistageRocketTestCase(HodlTestCase):
    def test_multistage_rocket(self):
        ...
        tickets = [
            ...
            Tick(time='23-04-10T09:32:03-04:00:00', pre_close=pc, open=p_sell, latest=p_sell, ),
            Tick(time='23-04-10T09:32:04-04:00:00', pre_close=pc, open=p_sell, latest=p_sell, ),
            Tick(time='23-04-10T09:32:05-04:00:00', pre_close=pc, open=p_sell, latest=p_sell, ),
        ...
        tickets = [
            ...
            Tick(time='23-04-11T09:32:02-04:00:00', pre_close=pc_lv2, open=pc_lv2, latest=p_sell_lv2, ),
            Tick(time='23-04-11T09:33:01-04:00:00', pre_close=pc_lv2, open=pc_lv2, latest=p_buy_lv2, ),
