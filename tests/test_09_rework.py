...
class ReworkTestCase(unittest.TestCase):
    def test_rework(self):
        ...
        tickets = [
            ...
            Tick(day='23-04-10T09:31:00-04:00:00', pre_close=pc, open=p0, latest=p3, ),
            Tick(day='23-04-10T09:32:00-04:00:00', pre_close=pc, open=p0, latest=p0, ),
            Tick(day='23-04-10T09:33:00-04:00:00', pre_close=pc, open=p0, latest=p0, ),
            Tick(day='23-04-10T09:34:00-04:00:00', pre_close=pc, open=p0, latest=p0, ),
        ]
